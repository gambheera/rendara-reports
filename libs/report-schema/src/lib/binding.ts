 ...
 * JSONata `expr` plus an open property bag, mirroring the E1-S4 `ElementStyle`
 * stub) so the element models in this story have a legal, assignable binding
 * slot without pre-empting E1-S5. The `expr` is the binding's essence and is
 * stable across that refinement.
 *
